...
if __name__ == '__main__':
    ...
    G, G_reverse, concept_map, relation_map,conccept_set1 = conceptnet_graph('conceptnet_english.txt')

    print ('Num seed concepts:', len(all_seeds))
    print ('Populating domain aggregated sub-graph with seed concept sub-graphs.')
    triplets = domain_aggregated_graph(all_seeds, G, G_reverse, concept_map, relation_map)
    ...
    '''
    print ('Saving files.')
    pickle.dump(conccept_set1,open('utils/concepet1.pkl','wb'))
