...
parser.add_argument('--save_path', type=str, default='save/drt', metavar='B',
                    help='board dir')
parser.add_argument('--src_path', type=str, default='Art_comb', metavar='B',
                    help='directory of source datasets')
parser.add_argument('--trg_path', type=str, default='Art', metavar='B',
                    help='directory of target datasets')
parser.add_argument('--val_path', type=str, default='Art', metavar='B',
                    help='directory of target datasets')
...
domains = ['Clipart', 'Product','Real World']
for src_path in domains:
    dsets[src_path] = data_loader.load_training(src_path, batch_size, kwargs)
dsets[trg_path] = data_loader.load_training(trg_path, batch_size, kwargs)
dsets[val_path] = data_loader.load_testing(trg_path, batch_size, kwargs)


dset_classes = 65 #src_dataset.num_classes
